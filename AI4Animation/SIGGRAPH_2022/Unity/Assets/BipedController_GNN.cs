...
namespace DeepPhase {
    public class BipedController_GNN : AnimationController {
        ...
        // public void RetrieveContacts(List<Vector4> contacts) {//not used
        ...
        protected override void Setup() {	
            ...
            LeftFootIK = IK.Create(Actor.FindTransform("LeftLeg"), Actor.GetBoneTransforms("LeftFoot"));
            RightFootIK = IK.Create(Actor.FindTransform("RightLeg"), Actor.GetBoneTransforms("RightFoot"));
